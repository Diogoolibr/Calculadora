function calcularRaizes(){
  ...
  if (delta >= 0){
    ...
    document.getElementById("resultado").innerHTML = "Resultado: Raizes x1 = " + x1 + " e x2 = " + x2;
  } else {
    document.getElementById("resultado").innerHTML = "Resultado: A equação não possui raizes reais";
  }
}
